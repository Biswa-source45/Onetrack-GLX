...
function applyAlertNote(note, setShow, setText, setLabel, setColor) {
  if (note && typeof note === "object" && note.text) {
    ...
    setLabel(note.label || "");
    setColor(
      note.color && ALERT_NOTE_COLORS[note.color] ? note.color : "amber",
    );
  } else {
    setShow(false);
    setText("");
...
function parseRequestedProducts(rp) {
  ...
  if (arr.length === 0)
    return [{ id: 1, product: "", description: "", qty: "", oem: "" }];
  return arr.map((p, i) => ({
    id: i + 1,
    product: p.product || "",
...
export function EditTenderDialog({
  ...
  const isTenderAccountManager =
    !!user?.id && bid?.account_manager?.id === user.id;
  const isTenderReportingManager =
    !!user?.id && bid?.reporting_manager?.id === user.id;
  const canChangeOwner =
    isAdmin || isTenderAccountManager || isTenderReportingManager;
  ...
  useEffect(() => {
          ...
          setForm({
            ...
            quantity:
              b.quantity !== undefined && b.quantity !== null
                ...
                : "",
            estimated_value:
              b.estimated_value !== undefined && b.estimated_value !== null
                ? String(b.estimated_value)
                : "",
            emd_amount:
              b.emd_amount !== undefined && b.emd_amount !== null
                ? String(b.emd_amount)
                : "",
            emd_not_applicable: !!b.emd_not_applicable,
            emd_exemption_types: Array.isArray(b.emd_exemption_types)
              ? b.emd_exemption_types
              : [],
            emd_exemption_reason: b.emd_exemption_reason || "",
            bg_required: !!b.bg_required,
            bg_rate:
              b.bg_rate !== undefined && b.bg_rate !== null
                ? String(b.bg_rate)
                : "",
            bg_duration_months:
              b.bg_duration_months !== undefined &&
              b.bg_duration_months !== null
                ? String(b.bg_duration_months)
                : "",
            opening_date: safeDateStr(b.opening_date || b.start_date),
            closing_date: safeDateTimeStr(
              b.closing_date ||
                b.end_date ||
            ...
            remarks: b.remarks || "",
            reporting_manager_id:
              b.reporting_manager?.id || b.reporting_manager_id || "",
            account_manager_id:
              b.account_manager?.id || b.account_manager_id || "",
    ...
    if (bid && open) {
      setForm({
        ...
        quantity:
          bid.quantity !== undefined && bid.quantity !== null
            ? String(bid.quantity)
            : "",
        estimated_value:
          bid.estimated_value !== undefined && bid.estimated_value !== null
            ? String(bid.estimated_value)
            : "",
        emd_amount:
          bid.emd_amount !== undefined && bid.emd_amount !== null
            ? String(bid.emd_amount)
            : "",
        emd_not_applicable: !!bid.emd_not_applicable,
        emd_exemption_types: Array.isArray(bid.emd_exemption_types)
          ? bid.emd_exemption_types
          : [],
        emd_exemption_reason: bid.emd_exemption_reason || "",
        bg_required: !!bid.bg_required,
        bg_rate:
          bid.bg_rate !== undefined && bid.bg_rate !== null
            ? String(bid.bg_rate)
            : "",
        bg_duration_months:
          bid.bg_duration_months !== undefined &&
          bid.bg_duration_months !== null
            ? String(bid.bg_duration_months)
            : "",
        ...
        remarks: bid.remarks || "",
        reporting_manager_id:
          bid.reporting_manager?.id || bid.reporting_manager_id || "",
        account_manager_id:
          bid.account_manager?.id || bid.account_manager_id || "",
      ...
      const payload = {
        ...
        bg_duration_months:
          form.bg_required && form.bg_duration_months
            ...
            : null,
        start_date: form.opening_date
          ? new Date(form.opening_date).toISOString()
          : null,
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <Field label="BID Number/RFP Number">
                            <Input
                              ...
                              onChange={(e) =>
                                set("gem_bid_no", e.target.value)
                              }
                              placeholder="GEM/2026/B/12345 or RFP/2026/012"
                              className={inputCls()}
                            />
                          </Field>
                            ...
                            <div className="col-span-2 space-y-3">
                              <label className="flex items-center gap-2.5 cursor-pointer select-none p-3 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800">
                                ...
                                <span className="text-xs font-medium text-blue-800 dark:text-blue-200">
                                  <strong>EMD via Online Payment</strong> — tick
                            ...
                            <div className="col-span-2 space-y-3">
                              <label className="flex items-center gap-2.5 cursor-pointer select-none p-3 rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800">
                                ...
                                <span className="text-xs font-medium text-amber-800 dark:text-amber-200">
                                  <strong>EMD via Demand Draft (DD)</strong> —
                                  tick if the tender document offers this route.
                                </span>
                              </label>
                              {emdDdOn && (
                                <div className="grid grid-cols-2 gap-3">
                          ...
                          {!form.emd_not_applicable && (
                            <div className="col-span-2 space-y-2 p-3 rounded-lg bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800">
                              <p className="text-xs font-semibold text-emerald-800 dark:text-emerald-200">
                                Exemption Criteria Listed In The Tender (tick
                                all that apply)
                              </p>
                              <div className="flex flex-wrap items-center gap-4">
                                {["MSME", "STARTUP", "OTHER"].map((t) => (
                                  ...
                                  >
                                    <input
                                      type="checkbox"
                                      checked={form.emd_exemption_types.includes(
                                        t,
                                      )}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <Field label="Start Date">
                            <Input
                              ...
                              onChange={(e) =>
                                set("opening_date", e.target.value)
                              }
                              className={inputCls()}
                            />
                          </Field>
                          <Field label="End Date">
                            <Input
                              ...
                              onChange={(e) =>
                                set("closing_date", e.target.value)
                              }
                              className={inputCls()}
                            />
                          </Field>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          >
                            <DropdownMenu>
                              <DropdownMenuTrigger
                                asChild
                                disabled={usersLoading || !canChangeOwner}
                              >
                                <Button
                                  variant="outline"
                                  size="sm"
                                  disabled={usersLoading || !canChangeOwner}
                                  className={`w-full h-8 text-xs font-normal justify-between bg-background text-foreground hover:bg-muted/50 gap-1.5 ${errors.bid_owner_id ? "border-destructive" : "border-input"}`}
                                >
                                  <span>
                                    {form.bid_owner_id
                                      ? (users.find(
                                          (u) => u.id === form.bid_owner_id,
                                        )?.full_name ?? "Select owner...")
                                      : "Select owner..."}
                                  </span>
                                  <ChevronDown className="size-3 text-muted-foreground ml-auto" />
                                </Button>
                            ...
                            {!canChangeOwner && (
                              <p className="text-[11px] text-muted-foreground">
                                Only this tender's Account Manager or Reporting
                                Manager can reassign the owner.
                              </p>
                            )}
                          </Field>
                            ...
                            <DropdownMenu>
                              ...
                              >
                                <Button
                                  variant="outline"
                                  size="sm"
                                  className="w-full h-8 text-xs font-normal justify-between bg-background text-foreground hover:bg-muted/50 gap-1.5 border-input"
                                >
                                  <span>
                                    {form.reporting_manager_id
                                      ? (users.find(
                                          (u) =>
                                            u.id === form.reporting_manager_id,
                            ...
                            <DropdownMenu>
                              ...
                              >
                                <Button
                                  variant="outline"
                                  size="sm"
                                  className={`w-full h-8 text-xs font-normal justify-between bg-background text-foreground hover:bg-muted/50 gap-1.5 ${errors.account_manager_id ? "border-destructive" : "border-input"}`}
                                >
                                  <span>
                                    {form.account_manager_id
                                      ? (accountManagers.find(
                                          (u) =>
                                            u.id === form.account_manager_id,
                                        )?.full_name ??
                                        users.find(
                                          (u) =>
                                            u.id === form.account_manager_id,
                        ...
                        note surfaced in the identification alert/mail. */}
                          <div className="sm:col-span-2">
                            {!showAlertNote ? (
                              ...
                              >
                                <Plus className="size-3.5" /> Add Additional
                                Info / Challenge
                              </button>
                            ) : (
                              <div className="space-y-2 p-3 rounded-lg border border-border/60 bg-muted/20">
                                ...
                                <Textarea
                                  value={alertNoteText}
                                  onChange={(e) =>
                                    setAlertNoteText(e.target.value)
                                  }
          ...
          <AnimatePresence>
            {amOwnerCaution && (
              <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                ...
                >
                  <h3 className="text-sm font-semibold text-foreground">
                    Can't assign the Account Manager as owner
                  </h3>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    This user is this tender's Account Manager — the approving
                    authority for its Primary Review Go/No-Go and pricing
                    sign-off. Assigning them as Bid Owner too would let them
                    review their own work, so choose a different owner.
                  </p>
