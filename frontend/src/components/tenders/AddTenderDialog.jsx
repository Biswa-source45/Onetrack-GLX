...
const PORTAL_SOURCES = ["GeM", "Private", "RTC", "CPPP", "eProcure", "Others"];
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Choose how you want to add this tender
          </p>
        </div>
        <button
          onClick={onClose}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field label="Bid No / Reference">
                <Input
                  ...
                  placeholder="TENDER/2026/IT/001"
                  className={inputCls()}
                />
              </Field>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field label="EMD Amount (₹)">
                <Input
                  ...
                  onChange={(e) => set("emd_amount", e.target.value)}
                  placeholder="e.g. 50000"
                  className={`${inputCls()} ${form.emd_exempted || form.emd_not_applicable ? "opacity-50" : ""}`}
                ...
                <DropdownMenu>
                  ...
                  >
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full h-8 text-xs font-normal justify-between bg-background border-input text-foreground hover:bg-muted/50 gap-1.5 disabled:opacity-50"
                    >
                      <span>
              ...
              <div className="space-y-2 pt-1">
                {[
                  ...(form.emd_exempted
                    ? []
                    : [{ field: "emd_not_applicable", label: "No EMD" }]),
                  ...(form.emd_not_applicable
                    ? []
                    : [{ field: "emd_exempted", label: "EMD Exempted" }]),
                  {
                    field: "oem_required",
                    label: "OEM Authorization Required",
                  },
